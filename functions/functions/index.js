...
// ─── POSTMARK CONFIG ───
const POSTMARK_TOKEN = functions.config().postmark?.token || process.env.POSTMARK_TOKEN;
const FROM_EMAIL = functions.config().postmark?.from || "notifications@wedchem.com";
